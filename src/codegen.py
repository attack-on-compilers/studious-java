        ...
        for t in tac.table:
            ...
            if len(t) == 4:
                ...
                if op == "+":
                    ...
                    instructions.append(f"  andq {parse_tac_arg(arg2)}, %rax")
                    ...
                    instructions.append(f"  orq {parse_tac_arg(arg2)}, %rax")
                    ...
                    instructions.append(f"  xorq {parse_tac_arg(arg2)}, %rax")
            ...
            if t[0] == "!":
                ...
                instructions.append(f"  cmpq $0, {parse_tac_arg(t[1])}")
                instructions.append(f"  sete %al")
                instructions.append(f"  movzbl %al, %eax")
                instructions.append(f"  movq %rax, {parse_tac_arg(t[2])}")
            ...
            if t[0] == "~":
                ...
                instructions.append(f"  notq %rax")
